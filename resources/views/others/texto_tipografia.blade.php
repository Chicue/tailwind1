    ...
    <div class="flex flex-wrap flex-row mt-2">
        <div class="text-justify w-1/2 p-5">
            ...
            <ul class="list-disc p-5">
                <li>
                    <p>sans , sans-serif, mono son los tipos de letra , sans es el por defecto</p>
                </li>
                <li>
                    <p>font-sans , font-serif, font-mono</p> 
                </li>
                <li>
                    <p>text-xl si le coloco un numero aumenta text-3xl</p> 
                </li>
                <li>
                    <p>text-xs si le coloco un numero aumenta text-3xs</p></br></br>
                </li>
                <li>
                    <p>espaciamiento entre letras tracking-tight tracking-tighter tracking-widest tracking-wide
        ...
        <div class="w-1/2">
            ...
            <!--text-xs si le coloco un numero aumenta text-3xs-->
                ...
                <h3 class="text-3xl font-serif bg-green-400 mx-auto mt-20 w-1/2 pt-5 pl-4">
                ...
                <h3 class="text-xs  font-mono bg-red-400 mx-auto mt-20 w-1/2 pt-5 pl-4">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et adipisci culpa delectus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa quasi illo nobis impedit voluptatibus unde ab adipisci tenetur veniam deleniti!
                </h3>
